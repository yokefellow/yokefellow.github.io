<template>
  <div class="cont" v-if="shouldShowDonate">
    ...
    <ul id="donateBox" class="list pos-f tr3">
      <li id="PayPal">
        <a href="https://paypal.me/Reinness?locale.x=zh_XC" target="_blank">PayPal</a>
      </li>
      <li id="QqPay" @click="showQR(QqQR)">QQ</li>
      <li id="AliPay" @click="showQR(AliPayQR)">AliPay</li>
      <li id="WeChat" @click="showQR(WeChanQR)">WeChat</li>
    </ul>
...
export default {
  ...
  data() {
    return {
      AliPayQR: require("./images/AliPayQR.png"),
      WeChanQR: require("./images/WeChatQR.png"),
      QqQR: require("./images/QqQR.png")
    };
  },
  watch: {
    $route(to, from) {
